...
class UploadStub(object):
    ...
    def __init__(self, channel):
        ...
        self.UploadChunk = channel.unary_unary(
                '/upload.Upload/UploadChunk',
                request_serializer=upload__pb2.Chunk.SerializeToString,
                response_deserializer=upload__pb2.ChunkResponse.FromString,
                _registered_method=True)
...
def add_UploadServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'UploadChunk': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=upload__pb2.ChunkResponse.SerializeToString,
            ),
    }
...
class Upload(object):
    ...
    def UploadChunk(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            upload__pb2.ChunkResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
